...
{
    public class MeltSpinController : Controller
    {
        // GET: Check/MeltSpin
        ...
        public JsonResult GetEquipments(string sidx, string sort, int page, int rows, bool _search, string searchField, string searchOper, string searchString)
        {
            ...
            var equipments = EquipmentDataAccessor.GetEquipments(Session["Account"] as Account, "MeltSpin").Data as List<EquipmentModel>;
